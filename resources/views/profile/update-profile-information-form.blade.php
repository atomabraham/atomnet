<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Mettre à jour vos information de profil et l\'adresse mail.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="secondname" type="text" class="mt-1 block w-full" wire:model="state.secondname" required
        ...
        <!-- Birthday -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="birthday" value="{{ __('Date de naissance') }}" />
            ...
            @if (Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::emailVerification()) &&
                ...
                <p class="text-sm mt-2">
                    ...
                    <button type="button"
                        ...
                        {{ __('Cliquez ici pour recevoir de nouveau l\'email de verification.') }}
                    </button>
                </p>
